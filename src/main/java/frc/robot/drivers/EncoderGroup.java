...
public class EncoderGroup extends SendableBase {
	...
	private EncodingType encoderType;
	...
	public EncoderGroup(int leftA, int leftB, boolean reverseLeft, int rightA, int rightB, boolean reverseRight, Encoder.EncodingType encoding) {
	...
	public void initSendable(SendableBuilder builder) {
		builder.setSmartDashboardType("Encoder Group");
